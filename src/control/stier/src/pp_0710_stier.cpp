...
SectionType get_section_from_rddf_idx(int idx_current) {
    ...
    else if((car.idx_current >= 1 && car.idx_current <= 136) or (car.idx_current >= 152 && car.idx_current <= 166) or (car.idx_current >= 179 && car.idx_current <= 201) or (car.idx_current >= 362 && car.idx_current <= 386) ) {
        section = SectionType::LANE_FOLLOWING;
    }
    else if((car.idx_current >= 167 && car.idx_current <= 178) or (car.idx_current >= 202 && car.idx_current <= 361)) {
        section = SectionType::LIDAR_ONLY;
    }
    else if(car.idx_current >= 137 && car.idx_current <= 151) {
