...
def main():
    ...
    file_path_drive = "2025-2-24_20-40_test-01_try-01.txt"
    options_drive = {
        "label" : file_path_drive+"(speed-10.0)",
        "color" : "blue",
        "start_point" : False
    }
    #plot_path_from_file(file_path_drive, ax, options_drive)

    file_path_drive = "2025-2-24_20-44_test-01_try-02.txt"
    options_drive = {
        "label" : file_path_drive+"(speed-20.0)",
        "color" : "blue",
        "start_point" : False
    }
    #plot_path_from_file(file_path_drive, ax, options_drive)

    file_path_drive = "2025-2-24_20-48_test-01_try-03.txt"
    options_drive = {
        "label" : file_path_drive+"(speed-15.0)",
        "color" : "blue",
        "start_point" : False
    }
    #plot_path_from_file(file_path_drive, ax, options_drive)

    file_path_drive = "2025-2-24_20-53_test-01_try-04.txt"
    options_drive = {
        "label" : file_path_drive+"(speed-15.0/arduino-timeout-off)",
        "color" : "green",
        "start_point" : False
    }
    plot_path_from_file(file_path_drive, ax, options_drive)

    file_path_drive = "2025-2-24_20-55_test-01_try-05.txt"
    options_drive = {
        "label" : file_path_drive+"(speed-20.0/arduino-timeout-off)",
        "color" : "blue",
        "start_point" : False
    }
    plot_path_from_file(file_path_drive, ax, options_drive)
    ...
    plt.savefig("25-02-24_bb-01_test-01.png", dpi=600, bbox_inches='tight')  # 300 DPI로 저장
    plt.show()
