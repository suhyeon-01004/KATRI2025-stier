...
def main():
    ...
    file_path_drive = "2025-2-24_21-52_test-06_try-01.txt"
    options_drive = {
        "label" : file_path_drive+"(speed-20.0/dist-ant/board-c099)",
        "color" : "red",
        "start_point" : False
    }
    plot_path_from_file(file_path_drive, ax, options_drive)

    file_path_drive = "2025-2-24_21-45_test-05_try-01.txt"
    options_drive = {
        "label" : file_path_drive+"(speed-20.0/box-ant/board-c099)",
        "color" : "orange",
        "start_point" : False
    }
    plot_path_from_file(file_path_drive, ax, options_drive)

    file_path_drive = "2025-2-24_21-7_test-03_try-01.txt"
    options_drive = {
        "label" : file_path_drive+"(speed-20.0/box-ant/board-red)",
        "color" : "purple",
        "start_point" : False
    }
    plot_path_from_file(file_path_drive, ax, options_drive)
    ...
    options_drive = {
        "label" : file_path_drive+"(speed-20.0/dish-ant/board-red)",
        "color" : "blue",
        "start_point" : False
    }
    plot_path_from_file(file_path_drive, ax, options_drive)
    ...
    plt.savefig("25-02-24_bb-01_test-01-03-05-06_board-compare.png", dpi=600, bbox_inches='tight')  # 300 DPI로 저장
    plt.show()
