...
def plot_path(path, ax, options):
    ...
    ax.plot(x_vals, y_vals, linestyle='-', markersize=1, label=label, color=color)
...
def main():
    ...
    file_path_drive = "2025-2-20_21-37_bb-02_case-03.txt"
    options_drive = {
    ...
    file_path_drive = "2025-2-20_21-33_bb-02_case-02.txt"
    options_drive = {
    ...
    file_path_drive = "2025-2-20_21-28_bb-02_case-01.txt"
    options_drive = {
        "label" : file_path_drive+"(speed=5.0)",
        "color" : "green",
        "start_point" : False
    }
    plot_path_from_file(file_path_drive, ax, options_drive)
    ...
    plt.savefig("25-02-20_bb-02", dpi=600, bbox_inches='tight')  # 300 DPI로 저장
    plt.show()
