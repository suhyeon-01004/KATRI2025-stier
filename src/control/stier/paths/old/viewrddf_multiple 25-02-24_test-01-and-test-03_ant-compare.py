...
def main():
    ...
    options_drive = {
        "label" : file_path_drive+"(speed-20.0/box-ant-1)",
        "color" : "red",
        "start_point" : False
    }
    plot_path_from_file(file_path_drive, ax, options_drive)

    file_path_drive = "2025-2-24_21-9_test-03_try-02.txt"
    options_drive = {
        "label" : file_path_drive+"(speed-20.0/box-ant-2",
        "color" : "orange",
        "start_point" : False
    }
    plot_path_from_file(file_path_drive, ax, options_drive)
    ...
    options_drive = {
        "label" : file_path_drive+"(speed-20.0/dish-ant)",
        "color" : "green",
        "start_point" : False
    }
    plot_path_from_file(file_path_drive, ax, options_drive)
    ...
    plt.savefig("25-02-24_bb-01_test-01-and-test-03_ant-compare.png", dpi=600, bbox_inches='tight')  # 300 DPI로 저장
    plt.show()
