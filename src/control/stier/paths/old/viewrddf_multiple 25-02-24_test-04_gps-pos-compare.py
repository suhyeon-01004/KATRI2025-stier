...
def main():
    ...
    file_path_drive = "2025-2-24_21-23_test-04_try-01.txt"
    options_drive = {
        "label" : file_path_drive+"(speed-20.0/box-ant-rear/powerbank-on)",
        "color" : "red",
        "start_point" : False
    }
    plot_path_from_file(file_path_drive, ax, options_drive)

    file_path_drive = "2025-2-24_21-32_test-04_try-02.txt"
    options_drive = {
        "label" : file_path_drive+"(speed-20.0/box-ant-rear/powerbank-on)",
        "color" : "orange",
        "start_point" : False
    ...
    file_path_drive = "2025-2-24_21-35_test-04_try-03.txt"
    options_drive = {
        "label" : file_path_drive+"(speed-20.0/box-ant-rear/powerbank-off)",
        "color" : "yellow",
        "start_point" : False
    }
    plot_path_from_file(file_path_drive, ax, options_drive)

    file_path_drive = "2025-2-24_21-38_test-04_try-05.txt"
    options_drive = {
        "label" : file_path_drive+"(speed-20.0/box-ant-mid/powerbank-on)",
        "color" : "green",
        "start_point" : False
    }
    plot_path_from_file(file_path_drive, ax, options_drive)
    ...
    plt.savefig("25-02-24_bb-01_test-04_gps-pos-compare.png", dpi=600, bbox_inches='tight')  # 300 DPI로 저장
    plt.show()
