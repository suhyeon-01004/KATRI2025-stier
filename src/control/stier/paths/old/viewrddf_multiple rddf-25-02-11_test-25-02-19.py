...
def main():
    ...
    file_path_drive = "2025-2-19_21-43_2-11.txt"
    options_drive = {
    ...
    file_path_drive = "2025-2-19_21-45_2-12.txt"
    options_drive = {
        "label" : file_path_drive,
        "color" : "cyan",
        "start_point" : False
    ...
    file_path_drive = "2025-2-19_21-49_2-12-s10.txt"
    options_drive = {
        "label" : file_path_drive,
        "color" : "green",
        "start_point" : False
    ...
    plt.savefig("rddf-25-02-11_test-25-02-19_only-s-10.png", dpi=600, bbox_inches='tight')  # 300 DPI로 저장
    plt.show()
