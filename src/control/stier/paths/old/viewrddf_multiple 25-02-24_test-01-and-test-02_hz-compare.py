...
def main():
    ...
    file_path_drive = "2025-2-24_21-0_test-02_try-01.txt"
    options_drive = {
        "label" : file_path_drive+"(speed-20.0/control-hz-8)",
        "color" : "red",
        "start_point" : False
    }
    ...
    options_drive = {
        "label" : file_path_drive+"(speed-20.0/acontrol-hz-16)",
        "color" : "green",
        "start_point" : False
    }
    plot_path_from_file(file_path_drive, ax, options_drive)
    ...
    plt.savefig("25-02-24_bb-01_test-01-and-test-02_hz-compare.png", dpi=600, bbox_inches='tight')  # 300 DPI로 저장
    plt.show()
